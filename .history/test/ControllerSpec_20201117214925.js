...
describe('controller', function () {
	...
	it('should show entries on start-up', function () {
		// TODO: write test
		var todo = {title: 'todo'}; //defines a todo
		setUpModel([todo]); //sets up the model

		subject.setView(''); //sets a view without specifiying a route

		expect(todo).toBeDefined();
		expect(view.render).toHaveBeenCalledWith('showEntries', [todo]); //expects the view to call the render method
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			...
			view.trigger('itemRemoved', {id: 42});

			expected(model.remove).toHaveBeenCalledWith(42, jasmine.any(Function));
