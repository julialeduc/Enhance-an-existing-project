...
describe('controller', function () {
	...
	it('should show entries on start-up', function () {
		...
		/* NOTE: The toHaveBeenCalledWith matcher will track all the arguments of its calls and 
		return true if the argument list matches any of the recorded calls to the spy */

		/* Expect the view to call the render method with the showEntries command and the array of todos to be displayed */
		expect(view.render).toHaveBeenCalledWith('showEntries', [todo]); 

		/* Expect the view to call the render method with the setFilter command and no specific parameter to filter for */
	...
	describe('routing', function () {
		...
		it('should show active entries', function () {
			...
			/* Expect the model to call the read method with {completed: false} as the query and 
			a callback function to return all the active todos from the database */
			expect(model.read).toHaveBeenCalledWith({completed: false}, jasmine.any(Function));

			/* Expect the view to call the render method with the showEntries command and the array of todos to be displayed */
			expect(view.render).toHaveBeenCalledWith('showEntries', [todo]);

			/* Expect the view to call the render method with the setFilter command and active as parameter to filter for active todos */
		...
		it('should show completed entries', function () {
			...
			/* Expect the model to call the read method with {completed: true} as the query and 
			a callback function to return all the completed todos from the database */
